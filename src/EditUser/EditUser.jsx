...
const EditUser = () => {
    ...
    const uniqueDepartments = [...new Set(users.map(user => user.department.value))];
    ...
    return (
      ...
      <section className="wrap">
            ...
            <div className="BtnSection">
                    ...
                    <button onClick={handleUndo} className="Select">Undo</button>
   
                <button onClick={handleSave} disabled={!hasChanges} className="Select">Save</button>
            </div>
        </div>
    );
};
